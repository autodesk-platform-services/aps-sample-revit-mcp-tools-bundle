...
A sample AppBundle for Automation API for Revit 2026 that executes custom tools on Revit Cloud Models. Designed to work with **[MCP Revit Automation](https://github.com/yourusername/mcp-revit-automation)** - allowing AI assistants like Claude or VS Code Copilot to orchestrate Revit operations through natural language.
